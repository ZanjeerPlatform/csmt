...
defmodule Storage do
  @moduledoc """
  Defines a general key-value storage for persisting and retrieval of the Compact Sparse Merkle Tree Nodes `t:CSMT.Types.tree_node/0`.
  ...
  def set_node(backend, key, value) do
    backend_module = CSMT.Utils.get_backend_module(backend)
